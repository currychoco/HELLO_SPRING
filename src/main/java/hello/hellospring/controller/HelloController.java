...
public class HelloController {
	...
	public String helloMvc(@RequestParam("name") String name, @RequestParam("name2") String name2, Model model) {
	...
	public String insertFormEmpInfo(@RequestParam(value = "name", required = false) String name,
			...
			@RequestParam(value = "hpNo", required = false) String hpNo, Model model) {
